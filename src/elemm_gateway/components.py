...
class SecurityPolicy:
    ...
    def is_action_allowed(self, action_id: str, method: Optional[str] = None) -> Dict[str, Any]:
        ...
        if action_id.startswith("elemm:") or action_id in ["connect_to_site", "get_manifest", "get_landmarks", "inspect_landmark", "list_aliases", "clear_session"] or action_id.endswith("_inspect"):
            return {"allowed": True}
