...
def test_presenter_redundancy_filter():
    ...
    md1 = presenter.present_manifest([lm1], hide_json=False, show_technical=True)
    md2 = presenter.present_manifest([lm2], hide_json=False, show_technical=True)
...
def test_presenter_short_description_filter():
    ...
    md = presenter.present_manifest([lm], hide_json=False, show_technical=True)
